...
export class FastChicken extends Chicken {
    constructor(x, y, canvas, path, basePath) {
        super(x, y, canvas, path);
        
        this.imageLeft.src = `${basePath}/assets/images/chicken/chicken_left_faster.png`;
        this.imageRight.src = `${basePath}/assets/images/chicken/chicken_right_faster.png`;
